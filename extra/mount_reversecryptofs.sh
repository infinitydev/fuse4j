...
FUSE_HOME=/usr
MOUNT_POINT="/home/tilo/rcryptofs"
FS_CLASS=com/bytestorm/fuse/ReverseCryptoFilesystem
...
CLASSPATH="$CLASSPATH:$M2_REPO/${PROJECT_NAME}/${PROJECT_NAME}-reversecryptofs/${VERSION}/${PROJECT_NAME}-reversecryptofs-${VERSION}.jar"
